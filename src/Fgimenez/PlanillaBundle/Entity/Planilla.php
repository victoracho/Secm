...
class Planilla {
     ...
     * @var \Doctrine\Common\Collections\Collection
     */
    private $planilla_notas_remision;


    /**
     * Add planillaNotasRemision
     *
     * @param \Fgimenez\PlanillaBundle\Entity\NotasRemisionDefinitivas $planillaNotasRemision
     *
     * @return Planilla
     */
    public function addPlanillaNotasRemision(\Fgimenez\PlanillaBundle\Entity\NotasRemisionDefinitivas $planillaNotasRemision)
    {
        $this->planilla_notas_remision[] = $planillaNotasRemision;

        return $this;
    }

    /**
     * Remove planillaNotasRemision
     *
     * @param \Fgimenez\PlanillaBundle\Entity\NotasRemisionDefinitivas $planillaNotasRemision
     */
    public function removePlanillaNotasRemision(\Fgimenez\PlanillaBundle\Entity\NotasRemisionDefinitivas $planillaNotasRemision)
    {
        $this->planilla_notas_remision->removeElement($planillaNotasRemision);
    }

    /**
     * Get planillaNotasRemision
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getPlanillaNotasRemision()
    {
        return $this->planilla_notas_remision;
    }
}
