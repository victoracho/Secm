    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('naturaleza', EntityType::class, array(
                    'class' => 'Fgimenez\PlanillaBundle\Entity\Naturaleza',
                    'label' => 'Naturaleza de la Queja',
                    'choice_label' => 'nombre',
                    'placeholder' => 'Seleccione',
                    'empty_data' => null,
                    'required' => true,
                    'query_builder' => function (EntityRepository $er) {
                        return $er->createQueryBuilder('n')
                                ->where("n.tipoRequerimiento=2")
                                ->orderby("n.id");
                    },
                ))
                ->add('condicion', EntityType::class, array(
                    'class' => 'Fgimenez\PlanillaBundle\Entity\Condicion',
                    'label' => 'Condicion de la Queja',
                    'choice_label' => 'nombre',
                    'placeholder' => 'Seleccione',
                    'empty_data' => null,
                    'required' => true,
