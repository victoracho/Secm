...
namespace Fgimenez\CrudBundle\Command;
...
class CrudGeneratorCommand extends GenerateDoctrineCrudCommand
{
    ...
    protected function configure()
    {
        ...
        $this
                ->setName('fgimenez:generate:crud')
                ->setDescription('generator CRUD heredado de petkopara, adaptado a AdminLTE')
                ->setDefinition(array(
...
EOT
    ...
    protected function getSkeletonDirs(BundleInterface $bundle = null)
    {
        ...
        $skeletonDirs[] = $this->getContainer()->get('kernel')->locateResource('@FgimenezCrudBundle/Resources/skeleton');
        $skeletonDirs[] = $this->getContainer()->get('kernel')->locateResource('@FgimenezCrudBundle/Resources');
